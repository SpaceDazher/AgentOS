"""Explicit freeze command for S1-018 (before final measurements).

Covers dependencies, sources, schemas, vocabulary, models, corpus/oracle,
rubric/decision rule, runner, evaluator, comparator, publisher and fixtures.
Replay rejects extra/missing/changed inputs. Regenerate explicitly; never
...
def main() -> int:
    ...
    manifest = {
        "schema": "agentos.s1-018.frozen-manifest/v1",
        "ticket": "S1-018",
        "hashes": hashes,
        "input_count": len(hashes),
        "note": ("Freeze covers dependencies, sources, schemas, vocabulary, "
                 "models, corpus/oracle, rubric/decision rule, runner, "
