"""S1-016 shared strict validator (canonical ops, states, envelopes).

Same fail-closed discipline as prior tickets: unknown fields/versions/enums,
duplicate JSON keys, NaN/Infinity, remote $ref, traversal in identity fields
and wrong types all fail closed. Offline only.
"""
import hashlib
import json
import math
...
SCHEMA_VERSION = "s1-016.lineage/v1"
EXPORT_PROFILE = "agentos.prov-export/v1"
