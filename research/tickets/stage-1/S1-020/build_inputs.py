...
OPEN_ITEMS = [
    ...
    ("NO-RUNTIME-RDF-SHACL-LLM-VERIFIER", ["S1-003", "S1-020"]),
    ("PLANNING-NUMBERS", ["S1-002", "S1-008", "S1-019", "PARK-03"]),
    ("REMAINING-QUANTITATIVE-ASSUMPTIONS", ["S1-002", "S1-004", "S1-012", "S1-019"]),
    ("UNVERIFIED-SOURCE-TAIL", ["S1-001", "PARK-02"]),
    ("SOURCE-REGISTRY-CONTROLLED-DEVIATION", ["S1-001", "S1-020"]),
    ("SOURCE-REGISTRY-ZSV-TAIL", ["S1-001", "S1-009"]),
    ("NEXT-STEP-1-BENCHMARK", ["S1-002"]),
    ("NEXT-STEP-2-P0-SYNTHESIS", ["S1-019"]),
    ("NEXT-STEP-3-COMPREHENSION-PILOT", ["S1-013"]),
    ("NEXT-STEP-4-PROFILE-C-POC", ["S1-018"]),
    ("NEXT-STEP-5-PROMOTE-CITED-U", ["S1-001", "PARK-02"]),
]
