...
| ID | Title | Org/Authors | Year | Type | URL | Key claim | Informs | Conf |
|----|-------|-------------|------|------|-----|-----------|---------|------|
| C1 | Role-Based Access Control Models | Sandhu, Coyne, Feinstein, Youman — IEEE Computer | 1996 | paper | https://doi.org/10.1109/2.485845 | Canonical RBAC0–3 family. Role explosion in per-agent delegation is a hub design inference, not a result claimed by this paper. | math | u |
...
| C8 | Cedar: A New Language for Expressive, Fast, Safe, and Analyzable Authorization | Cutler et al. (AWS/UCSD) | 2024 | paper (OOPSLA) | https://doi.org/10.1145/3649835 | Cedar has a decidable authorization model, SMT-based analysis, a Lean model, and differential validation of the implementation. | math | u |
| C9 | How We Built Cedar: A Verification-Guided Approach | Cedar authors | 2024 | paper (FSE Companion) | https://doi.org/10.1145/3663529.3663854 | Replacement for the invalid “Verified Cedar, SOSP 2023” record: verification-guided design connects the Lean model, Rust implementation, and differential/property testing. | math | u |
...
| C1 | c | https://doi.org/10.1109/2.485845 | каноническая IEEE-запись RBAC96; claim о role explosion помечен как дизайн-вывод |
...
| C8 | c | https://doi.org/10.1145/3649835 | исправлен venue: PACMPL/OOPSLA 2024, не PLDI |
| C9 | c | https://doi.org/10.1145/3663529.3663854 | исходная SOSP'23/memory-safety запись не существует; ID явно заменён работой FSE'24 |
...
Историческое примечание: B26 DOI исправлен в реестре; прежние C1/C8/C9 `x` разрешены
ручной проверкой раунда 13, включая явную replacement-запись C9.
