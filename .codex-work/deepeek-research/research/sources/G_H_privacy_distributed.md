...
| H7 | Kafka delivery semantics | Apache | 2011–24 | docs | https://kafka.apache.org/documentation/#semantics | Transport may be at-least-once; duplicate-safe local effects require consumer-side atomic processing/receipt, while unknown external outcomes still need reconciliation. | math | u |
...
- Delivery-контракт — at-least-once outbox + atomic local effect receipt; saga/compensation
  и reconciliation покрывают внешние или неизвестные исходы. Общая exactly-once не обещается.
