...
| J4 | Adaptive Concurrency Limits | Netflix Tech Blog | 2018 | blog | https://netflixtechblog.com/adaptive-concurrency-limits-5313f30ba8fe | Derive limits from RTT gradients instead of static QPS caps; prevents collapse under variable latency. | math | u |
...
| K5 | Meta-Analysis on Appropriate Reliance in Human-AI Decision Making | Schemmer et al. | 2022 | paper | https://arxiv.org/abs/2206.07621 | Quantifies over-/under-reliance drivers; explanations alone insufficient. | mental | u |
...
| J4 | x | — | slug/точная фраза/site-запросы пусты; пост реален — проверить вручную на Netflix TechBlog |
