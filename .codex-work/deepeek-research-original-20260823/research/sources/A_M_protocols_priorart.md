...
| A4 | MCP specification (latest) | Anthropic + community | 2025 | spec | https://modelcontextprotocol.io/specification/latest | Client/server primitives: tools, resources, prompts; sampling and elicitation as negotiated capabilities. | feat | u |
| A5 | MCP Authorization specification | MCP authors | 2025 | spec | https://modelcontextprotocol.io/specification/2025-06-18/basic/authorization | MCP servers as OAuth 2.1 resource servers with Protected Resource Metadata; never their own authorization servers. | arch | u |
| A6 | MCP spec revision 2025-11-25 (Tasks) | MCP authors | 2025 | spec | https://modelcontextprotocol.io/specification/2025-11-25 | Experimental Tasks: durable async operations with status/resume; formalized extensibility/capability negotiation. | feat | u |
...
| A5 | c | https://modelcontextprotocol.io/specification/2025-06-18/basic/authorization | точный путь виден только на zh-cn зеркале; ревизия подтверждена changelog'ом |
| A6 | v | https://modelcontextprotocol.io/specification/2025-11-25/basic/utilities/tasks | точное совпадение |
